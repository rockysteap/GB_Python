...
print(f'Сформирован список на {my_list_len} элементов: {my_list}')
print(f'Искомое число \'{my_num}\' встречается в списке {my_num_counter} раз(а). [счётчик в переменной]')
print(f'Искомое число \'{my_num}\' встречается в списке {my_dict[my_num]} раз(а). [счётчик в словаре]')
